...
export default function SysimustaSatkuOhje() {
  return (
    <Article title="Sysimusta Satku - Ohje">
      <h2>Ohjeita, mihin?</h2>
      <p>
      ...
      <p>
        ...
        <Link href="/sysimusta-satku-varustelistaesimerkki">
          esimerkinomainen varustelista
        </Link>
        saattaa auttaa ensihätään.
      </p>

      <h2>Entäpä ruoka ja juoma?</h2>
      ...
      <h2>Yleistä turvallisuudesta</h2>
      ...
      <ul className="list-disc">
        ...
        <li>kartta ja reittiohje (tapahtuman järjestäjiltä)</li>
        <li>huollon yhteystiedot (tapahtuman järjestäjiltä).</li>
      </ul>

      <p>
        Muu varustus on enemmän tai vähemmän hyödyllistä, mutta aikaisempien
        kokemusten perusteella koottu 
        <Link href="/sysimusta-satku-varustelistaesimerkki">varustelista</Link>
         antaa osviittaa siitä, mitä matkan varrella saattaa tarvita.
      </p>
    </Article>
  );
}
